...
tf.flags.DEFINE_integer('num_epochs', 1000, 'Number of epochs')  # 1500
...
tf.flags.DEFINE_integer('z_size_dim', 5, 'channel of latent variables')
tf.flags.DEFINE_integer('z_size_l', 10, 'length of latent variables')
tf.flags.DEFINE_integer('z_size_h', 1, 'height of latent variables')
tf.flags.DEFINE_integer('z_size_w', 1, 'width of latent variables')

tf.flags.DEFINE_float('lr_gen', 0.0002, 'learning rate for generator')
tf.flags.DEFINE_float('beta1_gen', 0.5, 'momentum term in Adam for generator')

tf.flags.DEFINE_float('refsig_gen', 1, 'sigma')  # 0.003
tf.flags.DEFINE_float('step_size_gen', 0.003, 'delta/ step size for langevin for generator')
...
tf.flags.DEFINE_float('refsig_des', 0.016, 'standard deviation of the reference distribution ')
tf.flags.DEFINE_float('step_size_des', 0.002, 'delta/ step size for langevin for descriptor')
...
tf.flags.DEFINE_string('data_path', './trainingVideo', 'path of the training data')
